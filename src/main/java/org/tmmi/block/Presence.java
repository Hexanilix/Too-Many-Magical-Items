...
//    public static Collection<Presence> instances = new HashSet<>();
//    private static Map<Presence, Inventory> gui;
//
//    private ItemStack item = newItemStack(Material.LAPIS_BLOCK, "Presence", 435234);
//    private Location location;
//    private BukkitTask task;
//    private int rad = 20;
//    private final Collection<UUID> whitelist = new HashSet<>();
//    private String name = "Presence 1";
//    private int timeout;
//
//    public Presence(Location loc) {
//        super(Material.LAPIS_BLOCK, loc);
//        Inventory i = Bukkit.createInventory(null, 54, "Presence ");
//    }
//
//    @Override
//    public void onPlace() {
...
//                else {
//                    l.setYaw(i);
//                    w.spawnParticle(Particle.END_ROD, l.multiply(rad/2d), 1, 0, 0 ,0 ,0);
//                    for (Player p : w.getPlayers())
//                        if (p.getLocation().distance(l) < rad && !whitelist.contains(p.getUniqueId()) && p.getGameMode() != GameMode.SPECTATOR) {
//                            timeout = 50;
//                        }
//                    i++;
//                }
...
//                            if (!whitelist.contains(p.getUniqueId())&& p.getLocation().distance(loc) < radius) {
...
//            player.openInventory(gui.get(this));
//    }
//
//    @Override
